...
const socialLinks = [
    {
      href: 'https://github.com/vijayverma4655/portfolio.git',
    ...
    {
      href: 'https://www.linkedin.com/in/vijay-verma-7804b8287',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.instagram.com/vijay_baghela_08?igsh=MWYxOWM5cGlwNGM0bg==',
        ...
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
                    Reach out tiday to discuss your project needs and start collaborating on something amazing!
                ...
                <form action="https://getform.io/f/bolgnqma" 
                method='POST'
                className="xl:pl-10 2xl:pl-20">
                    ...
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        ...
                        <div className="mb-4">
                            ...
                            className='text-field' 
                            required
                            placeholder='VijayBaghela@example.com'
                            autoComplete='name'
                            />
                        </div>
                    </div>

                    <div className="mb-4"><label htmlFor="message" className='label'>
                        Message
                        </label>
                        <textarea name="message" id="message" 
                        placeholder='Hi!'
                        required
                        className="text-field resize- min-h-32 max-h-80"></textarea>
                        </div>
